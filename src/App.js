      ...
      <header class="absolute top-0 left-0 z-10 flex w-full items-center bg-transparent">
        <div class="container">
          <div class="relative flex items-center justify-between">
            <div class="px-4">
              <a href="#home" class="block py-6 text-lg font-bold text-primary">Fahmi Ramdhani</a>
            </div>
        ...
        <div class="container">
          <div class="flex flex-wrap">
            <div class="w-full self-center px-4 lg:w-1/2">
              <h1 class="text-base font-semibold text-primary md:text-xl">Halo Semua 👋, saya <span class="mt-1 block text-4xl font-bold text-dark dark:text-white lg:text-5xl">Fahmi Ramdhani</span></h1>
              <h2 class="mb-5 text-lg font-medium text-secondary lg:text-2xl">Programmer</h2>
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="mb-10 w-full px-4 lg:w-1/2">
            ...
            <p class="max-w-xl text-base font-medium text-secondary lg:text-lg">I am a software engineer with a passion for developing high-quality software solutions. I have experience working with a variety of programming languages and technologies, and am skilled in languages such as Java, JavaScript, and Python. In addition to my technical skills, I am a strong team player with excellent communication and problem-solving abilities. I am excited to continue growing my career as a software engineer and am always open to new opportunities and challenges.</p>
          </div>
